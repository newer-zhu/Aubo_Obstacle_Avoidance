...
(cl:defmethod cl:initialize-instance :after ((m <SetPayload-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPayload-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aubo_msgs-srv:<SetPayload-request> is deprecated: use aubo_msgs-srv:SetPayload-request instead.")))

(cl:ensure-generic-function 'payload-val :lambda-list '(m))
(cl:defmethod payload-val ((m <SetPayload-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_msgs-srv:payload-val is deprecated.  Use aubo_msgs-srv:payload instead.")
  (payload m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetPayload-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPayload-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aubo_msgs-srv:<SetPayload-response> is deprecated: use aubo_msgs-srv:SetPayload-response instead.")))
