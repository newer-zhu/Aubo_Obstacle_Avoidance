...
(cl:defmethod cl:initialize-instance :after ((m <SetIO-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetIO-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aubo_msgs-srv:<SetIO-request> is deprecated: use aubo_msgs-srv:SetIO-request instead.")))

(cl:ensure-generic-function 'fun-val :lambda-list '(m))
(cl:defmethod fun-val ((m <SetIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_msgs-srv:fun-val is deprecated.  Use aubo_msgs-srv:fun instead.")
  (fun m))

(cl:ensure-generic-function 'pin-val :lambda-list '(m))
(cl:defmethod pin-val ((m <SetIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_msgs-srv:pin-val is deprecated.  Use aubo_msgs-srv:pin instead.")
  (pin m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <SetIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_msgs-srv:state-val is deprecated.  Use aubo_msgs-srv:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetIO-request>)))
  ...
  "344aecce520e21c4db398a398eb12110")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetIO-request)))
  "Returns md5sum for a message object of type 'SetIO-request"
  "344aecce520e21c4db398a398eb12110")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetIO-request>)))
  ...
  (cl:format cl:nil "int8 FUN_SET_RobotBoardUserDO = 1~%int8 FUN_SET_RobotBoardUserAO = 2~%int8 FUN_SET_ToolDigitalIO = 3~%int8 FUN_SET_RobotToolAO = 4~%int8 FUN_SET_ToolPowerType = 5~%int8 fun~%int8 pin~%float32 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetIO-request)))
  "Returns full string definition for message of type 'SetIO-request"
  (cl:format cl:nil "int8 FUN_SET_RobotBoardUserDO = 1~%int8 FUN_SET_RobotBoardUserAO = 2~%int8 FUN_SET_ToolDigitalIO = 3~%int8 FUN_SET_RobotToolAO = 4~%int8 FUN_SET_ToolPowerType = 5~%int8 fun~%int8 pin~%float32 state~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetIO-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetIO-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aubo_msgs-srv:<SetIO-response> is deprecated: use aubo_msgs-srv:SetIO-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetIO-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_msgs-srv:success-val is deprecated.  Use aubo_msgs-srv:success instead.")
  (success m))
